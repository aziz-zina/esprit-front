...
export class ClassroomsComponent {
    ...
    private readonly _academicYearService = inject(ClassroomService);
            ...
            this.columns.set([
                ...
                },
                {
                    ...
                    formatter: (rowData: any) =>
                        `${rowData.academicYear.startYear} - ${rowData.academicYear.endYear}`,
                },
    ...
    fetchPage() {
        this._academicYearService
            .getClassroomsPage(this.pageRequest())
            .subscribe((data) => {
                this.classrooms.set(data.content);
    ...
    openAddDialog(): void {
        const dialogRef = this._matDialog.open(AddClassroomComponent);
    ...
    openConfirmationDialog(data: Classroom): void {
        ...
        dialogRef
            ...
            .pipe(
                ...
                switchMap(() =>
                    this._academicYearService.deleteClassroomById(data.id).pipe(
